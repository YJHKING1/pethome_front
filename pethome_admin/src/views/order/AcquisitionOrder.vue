<template>
  <section>
    ...
    -->
    <el-table :data="acquisitionOrders" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <!--<el-table-column prop="digest" label="摘要" width="160" sortable>-->
      <!--</el-table-column>-->
      <el-table-column prop="address" label="地址" width="200" sortable>
      </el-table-column>
      <el-table-column label="操作">
        <template scope="scope">
          <el-button size="small" @click="handleConfirm(scope.$index, scope.row)">订单确认</el-button>
          <el-button type="danger" size="small" @click="handleCancel(scope.$index, scope.row)">取消</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-col :span="24" class="toolbar">
      ...
      <el-pagination layout="prev, pager, next" :current-page="currentPage" @current-change="handleCurrentChange" :page-size="pageSize" :total="totals" style="float:right;">
      </el-pagination>
    </el-col>

    <!--订单处理对话框-->
    <el-dialog title="确认订单" :visible.sync="acquisitionOrderFormVisible" :close-on-click-modal="false">
      <el-form :model="acquisitionOrderForm" label-width="80px" :rules="acquisitionOrderFormRules" ref="acquisitionOrderForm">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click.native="confirmOrder" :loading="acquisitionOrderLoading">确认</el-button>
      </div>
    </el-dialog>
